    ...
    <div class="row">
        ...
        <section class="mypage_sidebar">
            ...
            <article class="noticeheader">
                ...
                <span class="bbshit">조회수</span>
                <hr>
                <!--FAQ 게시글  -->
                <c:forEach items="${list}" var="bbsDTO" varStatus="status">
                    <article class="noticemiddle">
                        <span class="bbsnum">${bbsDTO.m_bId}</span>
                        <a href='bbsView?bId=<c:out value="${bbsDTO.m_bId}"/>'><span
                                class="bbstitle">${bbsDTO.m_bTitle}</span></a>
                ...
                <div style="display: flex; justify-content: flex-end;">
                    <button type="button" class="btn btn-outline-dark lg" onclick="location.href='bbswrite?bd=notice'"
                            style="margin-right: 20px;">글쓰기
                    </button>
                </div>
            </article>
        </section>
