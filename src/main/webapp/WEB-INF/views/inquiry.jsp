        ...
        <form method="post" action="#" style="width: 1000px;">
          <article>
            <table class="table">
              <tbody>
              <tr>
                <td><input type="text" class="form-control" placeholder="글 제목" name="inquirytitle" maxlength="40"></td>
              </tr>
              <tr>
                <td><textarea type="text" class="form-control" placeholder="글 내용을 작성하세요" name="inquirydetail" maxlength="1024"
            ...
            <div style="display: flex; justify-content: flex-end;">
              ...
              <a href=""><input type="submit" class="btn btn-outline-success" value="작성완료" style="margin-left: 10px;"></a>
            </div>
          </article>
        </form>
    </section>
