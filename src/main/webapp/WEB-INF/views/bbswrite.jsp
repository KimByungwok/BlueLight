        ...
        <section class="mypage_sidebar">
            ...
            <article style="justify-content: center;">
                <form action="bbsWriteOK" id="bbsw" name="bbsw" encType="multipart/form-data" method="post">
                    ...
                    <label class="form-label">작성 게시판: <%=request.getParameter("bd")%>
                    </label>
                    <label class="form-label">작성자: <%=session.getAttribute("id")%>
                    </label>
                    ...
                    <div class="form-group">
		                <textarea class="form-control" rows="10" name="bbs_thread" placeholder="내용을 입력해주세요" required>
                        </textarea><br>
