    ...
    <section class="mypage_sidebar">
        ...
        <article class="noticeheader">
            ...
            <article class="noticemiddle">
                ...
                <br>
                <div>
                    <a href="donation1payment"><button class="btn-outline-primary btn-lg" style="">후원하기</button></a>
                    <a href="livedonation1payment"><button class="btn-outline-success btn-lg" style="">현장후원</button></a>
                    <a href="donation"><button class="btn-outline-dark btn-lg" style="">목록</button></a>
                </div>
            </article>
        </article>
    </section>
